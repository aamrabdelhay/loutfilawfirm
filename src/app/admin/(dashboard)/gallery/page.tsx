...
const fields: FieldDef[] = [
  ...
  { name: "image", label: "Image path / URL", type: "image", full: true },
...
export default function AdminGalleryPage() {
  const rows = listGalleryImages().map((g) => ({ ...g, altEn: g.altEn, published: g.published, order: g.order }));
  return <CmsCRUD table="GalleryImage" title="Office Gallery" columns={["altEn", "image", "order", "published"]} fields={fields} rows={rows} />;
}
